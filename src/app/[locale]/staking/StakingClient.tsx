...
export const StakingClient = (props: { poolInfo: PoolInfoResponse, poolStakeSnapshot: PoolStakeSnapshotResponse, validatorInfo: ValidatorData }) => {
    ...
    return (
        <div>
            ...
            <main>
                {activePool === 'cardano' && (
                    <CardanoStaking poolInfo={poolInfo} poolStakeSnapshot={poolStakeSnapshot} />
                )}
