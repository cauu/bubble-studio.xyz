...
export default function Staking() {
    ...
    const [poolInfo, setPoolInfo] = useState<PoolInfoResponse | null>(null);
    const [poolStakeSnapshot, setPoolStakeSnapshot] = useState<PoolStakeSnapshotResponse | null>(null);
    const [poolDelegators] = useState<PoolDelegatorsResponse>([]);
        ...
        const fetchData = async () => {
            try {
                ...
                if (poolInfoCacheValue) {
                    setPoolInfo(poolInfoCacheValue.poolInfo);
                    setPoolStakeSnapshot(poolInfoCacheValue.poolStakeSnapshot);
                }
    ...
    if (loading || !poolInfo || !poolStakeSnapshot) {
