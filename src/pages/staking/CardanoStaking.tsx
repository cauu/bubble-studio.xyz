        ...
        <div>
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <section className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 mt-4">
                    <MetricCard icon="💰" title={t('metric.totalPledge')} value={numberWithCommas(activeStake)} description="ADA" progressValue={saturation} />
                    ...
                    <MetricCard icon="🔄" title={t('metric.relaysStatus')} value={
                        <div className="py-2">
